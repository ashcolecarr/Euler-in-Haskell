...
main = do
  ...
  putStr $ "The denominator, in lowest common terms, of the product of the four non-trivial curious fractions is "
...
finalDenominator (num, denom) = denom `div` (gcd num denom)