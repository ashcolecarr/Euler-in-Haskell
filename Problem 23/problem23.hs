...
main = do
  ...
  putStr $ "The sum of the positive integers which cannot be written as the sum of two abundant numbers is "
...
-- Note: the lower bound for numbers that can all be expressed as the sum of two abundant numbers is 20161 rather than 28123.
limit :: Int
limit = 20161
...
-- If condition checks if number is a perfect square, otherwise it will erroneously return duplicate divisors.
divisors :: Int -> [Int]
